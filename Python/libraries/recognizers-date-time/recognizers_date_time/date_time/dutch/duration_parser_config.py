...
class DutchDurationParserConfiguration(DurationParserConfiguration):
    ...
    def __init__(self, config):
        ...
        self._unit_map: Dict[str, str] = DutchDateTime.UnitMap
        self._unit_value_map: Dict[str, int] = DutchDateTime.UnitValueMap
        self._double_numbers: Dict[str, float] = DutchDateTime.DoubleNumbers
