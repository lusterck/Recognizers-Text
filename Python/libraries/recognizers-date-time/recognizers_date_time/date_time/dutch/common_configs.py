...
from recognizers_number.number.dutch.extractors import DutchCardinalExtractor, DutchIntegerExtractor, DutchOrdinalExtractor
...
class DutchCommonDateTimeParserConfiguration(BaseDateParserConfiguration):
    ...
    def __init__(self):
        ...
        self._date_parser = BaseDateParser(
            DutchDateParserConfiguration(self))
