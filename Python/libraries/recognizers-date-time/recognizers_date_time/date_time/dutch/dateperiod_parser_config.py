...
class DutchDatePeriodParserConfiguration(DatePeriodParserConfiguration):
    ...
    def is_week_only(self, source: str) -> bool:
        trimmed_source = source.strip().lower()
        return any(trimmed_source.endswith(o) for o in DutchDateTime.WeekTerms)
    ...
    def is_year_only(self, source: str) -> bool:
        trimmed_source = source.strip().lower()
        return any(trimmed_source.endswith(o) for o in DutchDateTime.YearTerms) or\
            (any(trimmed_source.endswith(o) for o in DutchDateTime.GenericYearTerms)
